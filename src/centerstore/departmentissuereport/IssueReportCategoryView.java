 ...
 * @author SUSHIL
 */
public class IssueReportCategoryView extends javax.swing.JDialog {
...
//        jLabel4.setVisible(false);
    ...
    public void setComboCategoryName(String[] itemName){
        ...
        comboCategoryName.setModel(itemmodel);
    }
    public void setComboCategoryName(String itemName){
        comboCategoryName.setSelectedItem(itemName);
    }
    ...
    public boolean getBooleanIncludeAllCategoryName(){
...
//    }
   ...
   public void addComboItemNameSelectListener(ActionListener ListenForSelect){
       comboCategoryName.addActionListener(ListenForSelect);
   }
   ...
   public void clearAll(){
       ...
       if(comboCategoryName.getModel().getSize() >= 1)
       {
     ...
     public JComboBox returnComboCategoryName(){
    ...
    public Map getIssueCategoryAllParams(){
         Map param = new HashMap<>();
         param.put("title", "Issue Return Report of All Category");
     ...
     public Map getIssueDepAll(){
         Map param = new HashMap<>();
         param.put("title", "Issue Report of All Category for " + getComboStoreName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
     ...
     public Map getIssueAllDepCategory(){
         Map param = new HashMap<>();
         param.put("title", "Issue Report of " +getComboCategoryName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
         param.put("category", getItemId());
         return param;
     }
      
     public Map getIssueDepCategory(){
         Map param = new HashMap<>();
         param.put("title", "Issue Report of " + getComboCategoryName() + " for " + getComboStoreName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
         param.put("category", getItemId());
         param.put("depId", getStoreId());
         return param;
     }
      
     public Map getIssueParams(){
         Map param = new HashMap<>();
     ...
     public Map getIssueParam(){
         Map param = new HashMap<>();
         param.put("title", "Issue Report of " +getComboCategoryName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
         param.put("pId", getItemId());
         return param;
     }
     
          public Map getReturnParam(){
         Map param = new HashMap<>();
         param.put("title", "Issue Report of " +getComboCategoryName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
     ...
     public Map getReturnCategoryAllParams(){
         Map param = new HashMap<>();
         param.put("title", "Issue Return Report of All Item");
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
     ...
     public Map getReturnDepCategory(){
         Map param = new HashMap<>();
         param.put("title", "Issue Return Report of " + getComboCategoryName() + " for " + getComboStoreName());
         param.put("frmDate", getStartDate());
         param.put("toDate", getEndDate());
         param.put("category", getItemId());
         param.put("depId", getStoreId());
    ...
    private void initComponents() {
        ...
        setTitle(" Center Store Category Issue/IssueReturn Report");
        setModalityType(java.awt.Dialog.ModalityType.DOCUMENT_MODAL);
        setResizable(false);

        comboCategoryName.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        comboCategoryName.setActionCommand("ComboItemName");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(comboCategoryName, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(checkboxIncludeAllDepartment, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(comboStoreName, 0, 142, Short.MAX_VALUE))
                .addGap(20, 20, 20))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(comboCategoryName, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssueReportCategoryView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IssueReportCategoryView dialog = new IssueReportCategoryView(new javax.swing.JFrame(), true);
...
//                });
    ...
    public javax.swing.JComboBox comboCategoryName;
