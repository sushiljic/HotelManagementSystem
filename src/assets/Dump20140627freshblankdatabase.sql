...
CREATE TABLE `bill` (
  ...
  `com_bill_datetime` date DEFAULT NULL,
...
INSERT INTO `sys_menu_info` VALUES (1,'Company Setup'),(2,'Basic Setup'),(3,'CenterStore'),(4,'Terminal Setup'),(5,'Terminal'),(6,'CenterStore Report'),(7,'Terminal Report'),(8,'System Date'),(9,'System Config');
...
CREATE TABLE `waiter_info` (
  ...
  CONSTRAINT `fk_designation_id` FOREIGN KEY (`designation_id`) REFERENCES `designation_info` (`designation_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
