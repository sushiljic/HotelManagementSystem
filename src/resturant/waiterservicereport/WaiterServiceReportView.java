 ...
 * @author SUSHIL
 */
public class WaiterServiceReportView extends javax.swing.JDialog {
...
//    private String UnitId = new String();
     ...
     */
    public WaiterServiceReportView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
       //super();
        initComponents();
     ...
     */
    public void setComboWaiterName(String[] itemName){
        DefaultComboBoxModel itemmodel = new DefaultComboBoxModel(itemName);
        comboWaiterName.setModel(itemmodel);
    }
    public void setComboWaiterName(String itemName){
        comboWaiterName.setSelectedItem(itemName);
    }
    public String getComboWaiterName(){
...
//        EndDateChooser.setDate(dt);
//    }
    public void setOnComboWaiterNameSelect(Object[] data){
        setWaiterId(Integer.parseInt(data[0].toString()));
   ...
   public void addComboWaiterNameSelectListener(ActionListener ListenForSelect){
       comboWaiterName.addActionListener(ListenForSelect);
   }
...
//      // data[2] = getStartDate();
//   }
   public Date[] getWaiterServiceReportDate(){
   ...
   //    checkRadioIssue();
     ...
     public JComboBox returnComboWaiterName(){
    ...
    public final void setButtonForEnter(JButton jb){
      ...
      public Map getReportParams(){
          ...
          param.put("title", "Waiter Service Report for " +getComboDepartmentName());
      ...
      public Map getReportParam(){
          Map param = new HashMap<>();
          param.put("title", "Waiter Service Report of " +getComboWaiterName() + " for " +getComboDepartmentName());
          param.put("frmDate",getStartDate());
          param.put("toDate",getEndDate());
          param.put("pId",getWaiterId());
          param.put("depId", getDepartmentId());
          return param;
      }
    /**
    ...
    private void initComponents() {
            ...
            public Component prepareRenderer(TableCellRenderer renderer, int row, int column){
                ...
                if(!isRowSelected(row)){
                    ...
                    //            if("Credit" == type ){
                        ...
                        //            }
                    if(type.equals("Total Amount Served")){
                        c.setBackground(new Color(227,197,132));
        ...
        setTitle("Waiter Service  Report");
        setModalityType(java.awt.Dialog.ModalityType.DOCUMENT_MODAL);

        comboWaiterName.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(comboWaiterName, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(comboWaiterName, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WaiterServiceReportView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WaiterServiceReportView dialog = new WaiterServiceReportView(new javax.swing.JFrame(), true);
...
//                });
    ...
    public javax.swing.JComboBox comboWaiterName;
