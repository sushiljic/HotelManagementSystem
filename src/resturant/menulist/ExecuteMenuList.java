 ...
 * @author SUSHIL
 */
public  class ExecuteMenuList  {
     public  MenuListView view;
   public  MenuListModel model;
  public   MenuListController cont;
    public ExecuteMenuList(MainFrameView mview,boolean modal){
        view = new MenuListView(mview,modal);
        model = new MenuListModel();
        cont  = new MenuListController(model,view,mview);
    ...
    public static void main(String[] args) {
        ...
        new ExecuteMenuList(new MainFrameView(),true); 
    }
