 ...
 * @author SUSHIL
 */
public class ServiceChargeReportView extends javax.swing.JDialog {
...
//    private String UnitId = new String();
     ...
     */
    public ServiceChargeReportView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
...
//      // data[2] = getStartDate();
//   }
   public Date[] getServiceChargeReportDate(){
   ...
   //    checkRadioIssue();
    ...
    public final void setButtonForEnter(JButton jb){
      ...
      public Map getReportParam(){
          ...
          para.put("title","SVC Report of " + getComboDepartmentName());
    ...
    private void initComponents() {
            ...
            public Component prepareRenderer(TableCellRenderer renderer, int row, int column){
                ...
                if(!isRowSelected(row)){
                    ...
                    //            if("Credit" == type ){
                        ...
                        //            }
                    if(type.equals("Total Service Charge Amount")){
                        c.setBackground(new Color(227,197,132));
        ...
        setTitle("Service Charge Report");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiceChargeReportView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ServiceChargeReportView dialog = new ServiceChargeReportView(new javax.swing.JFrame(), true);
