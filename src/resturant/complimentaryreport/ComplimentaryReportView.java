 ...
 * @author SUSHIL
 */
public class ComplimentaryReportView extends javax.swing.JDialog {
...
//    private String UnitId = new String();
     ...
     * @param modal
     */
    public ComplimentaryReportView(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
      // super();
        initComponents();
...
//    }
    public void setOnComboMenuNameSelect(Object[] data){
        setMenuId(Integer.parseInt(data[0].toString()));
...
//   }
   ...
   public void clearAll(){
      ...
      // setUnitId("");
       setStartDate(null);
       setEndDate(null);
       if(comboMenuName.getModel().getSize() >1){
   ...
   //    checkRadioIssue();
    ...
    public final void setButtonForEnter(JButton jb){
      ...
      public Map getReportParams(){
          ...
          para.put("title","Complimentary Report of All Item of " +getComboDepartmentName());
      ...
      public Map getReportParam(){
          Map para = new HashMap<>();
          para.put("title","Complimentary Report of " +getComboMenuName() + " of " +getComboDepartmentName());
          para.put("frmDate",getStartDate());
          para.put("toDate", getEndDate());
          para.put("pId",getMenuId());
          para.put("depId", getDepartmentId());
          return para;
      }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(comboMenuName, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComplimentaryReportView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ComplimentaryReportView dialog = new ComplimentaryReportView(new javax.swing.JFrame(), true);
