 ...
 * @author SUSHIL
 */
public class VoidView extends javax.swing.JDialog {
...
//    private String UnitId = new String();
     ...
     */
    public VoidView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
   ...
   //    checkRadioIssue();
    ...
    public final void setButtonForEnter(JButton jb){
      ...
      JTextField jf;
       ...
       public Map getReportParam(){
          ...
          para.put("title","Void Bill Report of " + getComboDepartmentName());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidView dialog = new VoidView(new javax.swing.JFrame(), true);
