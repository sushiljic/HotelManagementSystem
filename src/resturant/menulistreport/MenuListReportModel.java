 ...
 * @author SUSHIL
 */
public class MenuListReportModel extends DBConnect {
    public Object Itemdata[][] = null;
     ...
     public Object[][] getCategoryInfo(){
          ...
          ResultSet rsResult;
       String strQuery = "select item_category.category_id,item_category.category_name from item_category  ";
    ...
    //get subcategory
     public Object[][] getSubCategoryForCategory(int catid){
          PreparedStatement stmtItemInfo;
          ResultSet rsResult;
//       String strQuery = "select item_category.category_id,item_category.category_name from item_category where item_category.parent =? ";
        String strQuery = "SELECT sub_category_id,sub_category_name FROM item_sub_category WHERE category_id = ? ";
