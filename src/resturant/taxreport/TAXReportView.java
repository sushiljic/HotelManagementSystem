 ...
 * @author SUSHIL
 */
public class TAXReportView extends javax.swing.JDialog {
...
//    private String UnitId = new String();
     ...
     */
    public TAXReportView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
...
//   }
   ...
   //    checkRadioIssue();
    ...
    public final void setButtonForEnter(JButton jb){
      ...
      JTextField jf;
       ...
       public Map getReportParam(){
          ...
          para.put("title","VAT/TAX Report of " +getComboDepartmentName() );
    ...
    private void initComponents() {
        ...
        setTitle("Value Added Tax Report");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TAXReportView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TAXReportView dialog = new TAXReportView(new javax.swing.JFrame(), true);
