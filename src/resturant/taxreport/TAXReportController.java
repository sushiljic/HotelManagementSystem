...
import report.terminalSVReport.VATReport;
...
public class TAXReportController {
      TAXReportModel TRModel;
    TAXReportView TRView;
    private MainFrameView mainview;
    public TAXReportController(TAXReportModel model,TAXReportView view,MainFrameView main){
          TRModel  = model;
        TRView= view;
        mainview = main;
        /*
...
//                    Logger.getLogger(TAXReportController.class.getName()).log(Level.SEVERE, null, ex);
//                }
...
//                 }
                ...
                String report = "vatOnly.jrxml";
                title = "VAT Report";
                VATReport r = new VATReport(TRView.getReportParam(),report,title);
                 /*
