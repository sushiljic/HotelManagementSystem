 ...
 * @author SUSHIL
 */
public class MenuReport extends DBConnect{
     private Map param;
    //holds jasper design
    ...
    public MenuReport(Map m, String report, String title){
        param = m;
        initConnection();
        try{
            InputStream file = MenuReport.class.getResource(report).openStream();
