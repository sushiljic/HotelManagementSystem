 ...
 * @author SUSHIL
 */
public class PurchaseReport extends DBConnect {
     private Map param;
    //holds jasper designP
    ...
    public PurchaseReport(Map m, String report,String title){
        param = m;
        initConnection();
        try{
            InputStream file = PurchaseReport.class.getResource(report).openStream();
