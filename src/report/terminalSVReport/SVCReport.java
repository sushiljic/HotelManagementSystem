 ...
 * @author MinamRosh
 */
public class SVCReport extends DBConnect{
   private Map param;
    //holds jasper design
    ...
    public SVCReport(Map m, String report, String title){
        param = m;
        initConnection();
        try{
            InputStream file = SVCReport.class.getResource(report).openStream();//new FileInputStream(new File("D:\\DreamSys\\HotelManagementSystem\\src\\report\\terminaSVRReport\\SVCReport.jrxml"));
