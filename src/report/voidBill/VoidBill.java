 ...
 * @author SUSHIL
 */
public class VoidBill extends DBConnect{
    private Map param;
    //holds jasper design
    ...
    public VoidBill(Map m, String report, String title){
        param = m;
        initConnection();
        try{
            InputStream file = VoidBill.class.getResource(report).openStream();
