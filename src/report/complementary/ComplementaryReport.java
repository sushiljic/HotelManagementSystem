 ...
 * @author MinamRosh
 */
public class ComplementaryReport extends DBConnect{
   private Map param;
    //holds jasper design
    ...
    public ComplementaryReport(Map m, String report, String title){
        param = m;
        initConnection();
        try{
            InputStream file = ComplementaryReport.class.getResource(report).openStream();
