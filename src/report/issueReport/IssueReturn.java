 ...
 * @author MinamRosh
 */
public class IssueReturn extends DBConnect{
   private Map param;
    //holds jasper design
    ...
    public IssueReturn(Map m, String report, String title){
        param = m;
        initConnection();
        try{
            InputStream file = IssueReturn.class.getResource(report).openStream();//new FileInputStream(new File("D:\\DreamSys\\HotelManagementSystem\\src\\report\\terminalIRReport\\IssueReturn.jrxml"));
